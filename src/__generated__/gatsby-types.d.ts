...
type FileFieldsEnum =
  ...
  | 'childrenMdx.frontmatter.vssue_title'
  ...
  | 'childMdx.frontmatter.vssue_title'
...
type BlogPageQuery = { readonly currentPost: Maybe<(
    Pick<Mdx, 'body'>
    & { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title'>> }
...
type BlogIndexPageQueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
}>;


type BlogIndexPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
...
type CategoryIndexPageQueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
...
type CategoryIndexPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
        & { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<(
          Pick<MdxFrontmatter, 'title' | 'date'>
          & { readonly cover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
...
type TagIndexPageQueryVariables = Exact<{
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  tag: Scalars['String'];
}>;
...
type TagIndexPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
        & { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<(
          Pick<MdxFrontmatter, 'title' | 'date'>
          & { readonly cover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
...
type UseCategoryListQueryVariables = Exact<{ [key: string]: never; }>;


type UseCategoryListQuery = { readonly allMdx: { readonly group: ReadonlyArray<Pick<MdxGroupConnection, 'fieldValue' | 'totalCount'>> } };

type UseDefaultCoverQueryVariables = Exact<{ [key: string]: never; }>;


type UseDefaultCoverQuery = { readonly defaultCover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

type UseTagListQueryVariables = Exact<{ [key: string]: never; }>;


type UseTagListQuery = { readonly allMdx: { readonly group: ReadonlyArray<Pick<MdxGroupConnection, 'fieldValue' | 'totalCount'>> } };
